  ...
  return (
    <div className="main-content">
      <main>
        ...
        <div className='separator'></div>
        <p className='small indented'>Public deployment of SSIA is planned for 2025. If you would like to test or contribute to SSIA before deployment, please follow the external Feedback link in the toolbar.</p>
