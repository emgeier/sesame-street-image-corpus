...
function About() {
  return (
    <div>
      ...
      <div className='separator'></div>
    <main>
      <h1 className='intro'>About the Sesame Street Image Archive</h1>
